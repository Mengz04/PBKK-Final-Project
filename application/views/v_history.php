  ...
  background-size: cover;">
		<div class="col-md-12">
			<div class="d-flex flex-wrap" style="gap: 5px; color:white; ">
				...
				<div class="row p-2 m-3 mx-5 w-100" style="background-color: rgba(0, 0, 0, 1); border-radius: 10px; border: 3px solid orange;">
					<div class="col col-lg-4 col-sm-12 col-12 text-center p-0" style="background: url(<?=base_url('assets/gambar/ticket-bg-2.jpg')?>); background-size: contain; border-radius: 10px 0 0 10px; overflow: hidden;">
					...
					<div class="col col-lg-8 col-sm-12 col-12 d-flex justify-content-between gap-3 align-items-center p-3 flex-wrap" style="">
						<div class="ticket-p">
							<div class="d-flex" style="gap:10px;">
								<h2>CINEMA</h2>
								<h2 style="font-weight:15px; color: rgb(198, 128, 0);">TICKET</h2>
							</div>
						...
						<img src="<?=base_url('assets/gambar/qr-code.png')?>" alt="" style="max-height: 150px; background-color:white; border: 2px solid white">
					</div>
				</div>
